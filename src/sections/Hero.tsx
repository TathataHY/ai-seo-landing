...
export const Hero = () => {
  ...
  return (
    <motion.section
      ...
      style={{ backgroundImage: `url(${startsBg.src})`, backgroundPositionY }}
    >
      ...
      <div className="container relative mt-16">
        <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgba(74,32,138,.5))] text-transparent bg-clip-text text-center">
          AI SEO
        </h1>
